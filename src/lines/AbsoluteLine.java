...
public class AbsoluteLine extends SuperLine {
    ...
    public AbsoluteLine(BigDecimal[] oldPoint, BigDecimal[] newPoint) {
    ...
    public String lineForDesmos() {
        ...
        if (isLinear) {
            ...
            if (h.compareTo(new BigDecimal(0)) >= 0 && k.compareTo(new BigDecimal(0)) >= 0) {
                returnedLine = format("y = {0}\\left|x - {1}\\right| + {2}",
                        fracA,
                        h.toPlainString(),
                        k.toPlainString());
    ...
    public String mirroredLineForDesmos() {
        return (new AbsoluteLine(oldPoint, newPoint)).lineForDesmos();
    }
}