...
public class QuadraticLine {
    /*
     * TODO: finish the quadratic line equations and then format the lines for normal
     * and lines for desmos methods.
     */
 ...
 */
    ...
    public String lineForDesmos() {
        ...
        if(isLinear){
            ...
            returnedLine = "y = " + a + "x - " + Math.abs(k) + "\\left\\{" + domain[0] + "\\le x\\le" + domain[1]
                    + "\\right\\}";
        }
        return returnedLine;
    }
    ...
    public String lineForNormal() {
        ...
        if (isLinear) {
            ...
            returnedLine = "y = " + a + "x + " + k + " {" + domain[0] + "≤ x ≤" + domain[1] + "}";
        }
        return returnedLine;
    }
    ...
    //                     + "The equation for this line should be \'x = " + k + "\' since both points\' x values are "
    //                     + k + ".\n"
    ...
    //                     + "The equation for this line should be \'y = " + k + "\' since both points\' y values are "
    //                     + k + ".\n"
